...
CHIN_TO_STERNUM_THRESHOLD = 0.7  # 코-명치 거리 감소 비율 기준
...
# 버튼 생성
ttk.Button(root, text="코-명치 거리 측정", command=lambda: start_measurement('chin_to_sternum')).pack(pady=5)
        ...
        try:
            ...
            if is_measuring:
                if measurement_type == 'face_size':
                    ...
                    cv2.line(image, nose_px, sternum_px, (0, 255, 0), 2)  # 코-명치 선 표시
